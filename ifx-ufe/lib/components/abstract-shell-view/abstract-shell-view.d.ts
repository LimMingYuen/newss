...
export declare abstract class AbstractShellView {
     ...
     * @protected
     */
    protected appDeSelected$: import("rxjs").Subject<import("ifx-ufe").AppDescription>;
    /**
     * Emits when an app is deselected
     * @protected
     */
    protected appSelected$: import("rxjs").Subject<import("ifx-ufe").AppDescription>;
    /**
    ...
    protected currentLanguage$: import("rxjs").Observable<import("ifx-ufe").LanguageType>;
    /**
     ...
     * @protected
     */
    protected appList$: import("rxjs").Observable<import("ifx-ufe").AppDescription[]>;
    /**
     ...
     * @protected
     */
    protected activeApps$: import("rxjs").Observable<import("ifx-ufe").AppDescription[]>;
    /**
     ...
     * @protected
     */
    protected layout$: import("rxjs").Observable<string>;
