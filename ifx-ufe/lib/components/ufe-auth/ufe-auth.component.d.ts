...
export declare class UfeAuthComponent {
    ...
    languageToggle: import("@angular/core").OutputEmitterRef<string>;
    logoutLabel: string;
    menuExternalLinks: import("@angular/core").Signal<import("../../models/AppLink").AppLink[]>;
    menuHelpLinks: import("@angular/core").Signal<HelpItem[]>;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<UfeAuthComponent, "ifx-ufe-auth", never, { "externalLinks": { "alias": "externalLinks"; "required": false; "isSignal": true; }; "helpLinks": { "alias": "helpLinks"; "required": false; "isSignal": true; }; "hideJwtCounter": { "alias": "hideJwtCounter"; "required": false; "isSignal": true; }; }, { "logout": "logout"; "languageToggle": "languageToggle"; }, never, ["*"], true, never>;
}
