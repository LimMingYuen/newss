...
export declare class WrlStateStore {
    ...
    wrlServiceLocatorUri: import("@angular/core").Signal<string | undefined>;
    initialized: import("@angular/core").Signal<boolean>;
    allowLocalResources: import("@angular/core").Signal<boolean>;
    onlyLocalResources: import("@angular/core").Signal<boolean>;
    localWebResources: import("@angular/core").Signal<WebResource[]>;
     ...
     */
    setLocalResources(localWebResources: WebResource[]): void;
    /**
