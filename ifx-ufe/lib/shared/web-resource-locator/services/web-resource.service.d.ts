...
export declare class WebResourceService {
     ...
     */
    initWrl(wrlConfig: WRLConfig, resourceSelectionStrategy?: ((resources: Array<WebResource>, currentActiveResourceVersion?: WebResource) => WebResource | undefined) | undefined, resourceNotFoundHandler?: ((applicationName: string, resourceName: string) => void) | undefined): Promise<void>;
    /**
     ...
     */
    getResourceUrisFromWrlLocal(applicationName: string, resourceName: string): WebResource[];
    loadWrlLocalResources(wrlConfig: WRLConfig): Promise<void>;
    /**
